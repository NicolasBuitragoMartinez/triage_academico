...
class IAControllerTest {
        ...
        @Test
        @DisplayName("POST /api/ia/sugerir-clasificacion - debe retornar 200 con sugerencia")
        ...
        void sugerirClasificacion_debeRetornar200() throws Exception {
                ...
                request.setSolicitudId(1L); // ← Agregar solicitudId
                request.setDescripcion("Necesito homologar materias para graduarme");
                ...
                SugerenciaClasificacionResponse response = SugerenciaClasificacionResponse.builder()
                                ...
                                .explicacion("La solicitud menciona homologacion y graduacion")
                                .confianza(0.95f)
        ...
        @Test
        @DisplayName("POST /api/ia/sugerir-clasificacion - con descripcion vacia debe retornar 400")
        @WithMockUser(roles = "ADMINISTRATIVO")
        void sugerirClasificacion_descripcionVacia_debeRetornar400() throws Exception {
                SugerenciaClasificacionRequest request = new SugerenciaClasificacionRequest();
        ...
        @Test
        @DisplayName("GET /api/ia/resumen/{solicitudId} - debe retornar 200 con resumen")
        @WithMockUser(roles = "ADMINISTRATIVO")
        void generarResumen_debeRetornar200() throws Exception {
                ResumenSolicitudResponse response = ResumenSolicitudResponse.builder()
                                .solicitudId(1L)
                                .resumen("Resumen generado por IA de la solicitud #1")
                                .build();
                ...
                mockMvc.perform(get("/api/ia/resumen/1"))
                                ...
                                .andExpect(jsonPath("$.resumen").value("Resumen generado por IA de la solicitud #1"));
        }
